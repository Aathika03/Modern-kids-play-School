...
export default function NoticeBoard({ notices }: NoticeBoardProps) {
  ...
  return (
    <section className="py-6 md:py-8 bg-[#c6e2eeff] border-y border-[#D3ECF6]">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">

        {/* Heading */}
        <h2 className="text-2xl sm:text-3xl md:text-4xl font-extrabold text-[#204d63] text-center mb-5">
          Notice Board
        </h2>
